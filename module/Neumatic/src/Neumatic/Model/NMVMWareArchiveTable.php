...
class NMVMWareArchiveArchiveTable extends DBTable
{
    protected $dbIndex = 'neumatic';
   	protected $tableName = 'vmware_archive';
    ...
    /**
     * @param NMVMWareArchive $s
     * @return NMVMWareArchive
     */
    public function save(NMVMWareArchive $s)
    {
        $this->sysLog->debug();
