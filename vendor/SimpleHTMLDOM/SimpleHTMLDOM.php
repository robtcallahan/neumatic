...
class simple_html_dom
{
    ...
    protected function parse_charset()
    {
        ...
        {
            /*
             * Commented out by Rob Callahan on 12/9/2014 because we don't have php-mbstring extension installed
             * nor can it be due to dependency issues. It's a gross assumption, but we'll just go ahead and assume
             * we have a character set of UTF-8. Should works just fine in most cases
             *
